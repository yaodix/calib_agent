...
//./build/detect_charuco -w=5 -h=4 -sl=0.04 -ml=0.032 -d=0 -v=/media/disk/yao/workspace/cam_calib/dict_44.png 
int main(int argc, char *argv[]) {
    ...
    charucoBoard.setLegacyPattern(true); // dict_44.png was generated with legacy=true (default in create_charucoboard)
    ...
    while(inputVideo.grab()) {
        ...
        imshow("out", imageCopy);
				cv::imwrite("charuco_detected.png", imageCopy);
